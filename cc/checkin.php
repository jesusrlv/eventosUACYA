...
<html lang="en">
  <head>
    ...
    <?php
      ...
      $rowEventos = $resultadoSitio2->fetch_assoc();
    ?>
...
<main class="mb-0">
  ...
  <div class="b-example-divider">
    <h4 class="text-secondary ms-5 mt-2 mb-4">NOMBRE DEL EVENTO: <span class="text-dark"><strong><?php echo $rowEventos['sitio'] ?></strong></span></h4>
  </div>
