...
<main class="mb-0">
  ...
  <div class="b-example-divider">
    ...
    <img src="../assets/brand/img/somos_fca_halcon_azul_15.png" width="270" height="" role="img" alt="" class="p-2" style="">
      <h1 class="mt-2 display-1 text-bold" style="font-family: 'Titillium Web', sans-serif;">Registro Centro de Cómputo<br>UACYA</h1>
        ...
        <div class="row justify-content-center">
            ...
            <form action="checkin.php" method="POST">
                <div class="input-group mb-3 w-100 mt-5">
                    <span class="input-group-text" id="basic-addon1">Seleccionar Sitio</span>
                    <select class="form-select" aria-label="Default select example" name="evento">
                        <option selected>Seleccionar ...</option>
                        <?php
                          // include('../admin/query/query_eventos.php');
                          include('../admin/query/query_sitios.php');
                          while($rowEventos = $resultadoSitio->fetch_assoc()){
                            echo'
                            <option value="'.$rowEventos['id'].'">'.$rowEventos['sitio'].'</option>
                            ';
                          }
                        ?>
                    </select>
